...
import { Eye, Search, BarChart2, ExternalLink, Map, Table, Filter, ShieldAlert, CheckCircle2 } from 'lucide-react'
...
export default function CommandCenter() {
  ...
  const activeSarImage: SarSegmentedImage = SAR_SEGMENTED_IMAGES[selectedSpillIndex] || SAR_SEGMENTED_IMAGES[0]
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', height: '100%', overflow: 'hidden' }}>
      ...
      <div style={{ display: 'flex', flex: 1, overflow: 'hidden' }}>
          ...
          <div style={{
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
              ...
              <div>
                ...
                <div style={{ fontSize: 9, color: 'var(--text-muted)', fontFamily: 'JetBrains Mono' }}>
                  CLICK ANY ROW TO OPEN DETAILED HIGHLIGHTED IMAGE IN NEW TAB
                </div>
              </div>
            </div>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
              ...
              <div style={{ position: 'relative', display: 'flex', alignItems: 'center' }}>
                ...
                <input
                  type="text"
                  placeholder="Search spill, place..."
                  value={searchQuery}
                    ...
                    {filteredSpills.map((spill) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          {/* time with AM/PM */}
                          <td style={{ padding: '10px 12px', color: 'var(--accent-cyan)', whiteSpace: 'nowrap', fontWeight: 600 }}>
                            {spill.timeAmPm}
                          </td>
        ...
        {/* Right Side Column - INCIDENT RECORD (KEPT EXACTLY INTACT AS REQUESTED) */}
        <div style={{
          ...
          <div style={{ flex: 1, overflow: 'auto', padding: '12px' }}>
            ...
            {[
              ...
              { label: 'DETECTION TIMESTAMP', value: `${activeSarImage.date} ${activeSarImage.timeAmPm}` },
            ...
            <div style={{ display: 'flex', gap: '8px', flexDirection: 'column' }}>
              ...
              >
                <Eye size={13} /> VIEW DETECTION IN NEW TAB
              </button>
